...
NOTE: Version 1 of the same task can be found at: https://github.com/aszucs/cobra_task_v1.
...
➔ Szücs A, Edershile EA, Wright AG, Dombrovski AY. Rivalry and admiration-seeking in a social competition: From traits to behaviors through contextual cues. Personality Disorders: Theory, Research, and Treatment. 2023 Jul;14(4):429. DOI: 10.1037/per0000610 (full text freely available at: https://pmc.ncbi.nlm.nih.gov/articles/PMC10313745/)
...
[2]	Open the resulting *cobra_task_v2-main* folder (created when decompressing the zip file).

[3]	Carefully read the user manual *cobra_task_v2_manual.pdf* before launching the task.
